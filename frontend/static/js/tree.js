window.startTreeAnimation = function () {
    ...
    if (window.hasTreeAnimationRun) return;
    window.hasTreeAnimationRun = true;
    ...
    var e = !0, n = "#E8F6F8 #ACE8F8 #F6FBFE #A2CBDC #B74551 #5DBA72 #910B28 #910B28 #446D39".split(" "),
        p = ["#star", "#circ", "#cross", "#heart"], l = [], d = 0;
    ...
    (function () {
        ...
        k.to(".pContainer, .sparkle", {
            ...
            duration: 1, onStart: function () {
                e = !1
            }, x: q[0].x, y: q[0].y
        }).to(".pContainer, .sparkle", {
            duration: 2, onStart: function () {
                e = !0
            }, motionPath: {path: ".treeBottomPath", autoRotate: !1}, ease: "linear"
